...
test.describe('Departments', () => {
  ...
  test('Admin should add a department', async ({ departmentsPage, toastMessages, departmentName }) => {

    await departmentsPage.add(departmentName);
    await expect(toastMessages.successMessage).toBeVisible();
  });

  test('Admin should edit a department', async ({ departmentsPage, toastMessages, departmentName }) => {
  ...
  test('Admin should delete a department', async ({ departmentsPage, toastMessages, departmentName, page }) => {
    await departmentsPage.add(departmentName);
